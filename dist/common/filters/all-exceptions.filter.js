...
const logger = new common_1.Logger('AllExceptions');
let AllExceptionsFilter = class AllExceptionsFilter {
        ...
        const message = exception instanceof common_1.HttpException ? exception.getResponse() : exception?.message || exception;
